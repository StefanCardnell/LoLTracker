...
//g++ -std=c++0x -o main -I/usr/local/include -I/usr/include -I/usr/include/jsoncpp/ -lcurl -ljsoncpp -lncursesw CurrentGameLoopJSONPiInput.cpp CurrentGameFunctionsJSON.cpp
//USE THIS FOR WCHAR^^
